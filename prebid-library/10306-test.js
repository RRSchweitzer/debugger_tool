...
!function e(i, a, s) {
    function d(t, n) {
        if (!a[t]) {
            ...
            i[t][0].call(m.exports, function(e) {
                var a = i[t][1][e];
                return d(a || e)
            }, m, m.exports, e, i, a, s)
        }
    ...
    for (var r = "function" == typeof require && require, t = 0; t < s.length; t++)
        d(s[t]);
    return d
}({
    1: [function(e, i, a) {
        ...
        i.exports = function(e) {
            try {
                function i() {
                    for (var i = ["debug", "info", "warn", "error"], a = {}, d = 0; d < i.length; d++) {
                        var r = i[d];
                        a[r] = function(i) {
                            return function() {
                                if ("object" == typeof e && (e.logging || "function" == typeof e.getConfig && e.getConfig("debug")))
                                    try {
                                        window.console[i].apply(window.console, [i.toUpperCase() + " " + s + ":"].concat(Array.prototype.slice.call(arguments)))
                                    } catch (e) {}
                            }
                        }(r)
                    }
                ...
                function a(e, i, a) {
                    return r(r(e.getSizes(), a), i).map(function(e) {
                ...
                function n(e, i) {
                    return i.some(function(i) {
                        return e.getWidth() === i[0] && e.getHeight() === i[1]
                    })
                }
                function o(i, s) {
                    return s.find(function(s) {
                        var d = !1;
                        if (s.slotPattern && s.divPattern ? d = s.slotPattern.test(i.getAdUnitPath()) && s.divPattern.test(i.getSlotElementId()) : s.slotPattern ? d = s.slotPattern.test(i.getAdUnitPath()) : s.divPattern && (d = s.divPattern.test(i.getSlotElementId())),
                        d && l)
                            try {
                                (d = l({
                                    gptSlot: i,
                                    adUnitPattern: s
                                })) || I.warn("adunitPattern excluded because filtered out by custom mapping function:", s, i)
                            } catch (e) {
                                I.warn("custom mapping function error:", e)
                            }
                        if (d) {
                            if (s.filteredSizes = a(i, s.sizes, e.rp.sizes),
                            0 === s.filteredSizes.length)
                                return I.warn("adunitPattern excluded because all slot sizes filtered out:", s, i),
                                !1;
                            I.debug("adunitPattern/slot match found:", s, i)
                        }
                        return d
                    })
                }
                ...
                function m(e, i, a) {
                    if (i)
                        try {
                            ...
                            return s.code = e.getSlotElementId(),
                            s.sizes = s.filteredSizes,
                            s.bids.forEach(function(e) {
                                c(e, a)
                            }),
                            delete s.filteredSizes,
                            delete s.slotPattern,
                            delete s.divPattern,
                            delete s.customMappingParams,
                            s.transactionId || (s.transactionId = d()),
                            s
                        } catch (e) {
                            I.error("error parsing adUnit", e)
                        }
                    else
                        I.warn("createAdUnit: no adunitPattern found for slot:", e)
                }
                function b(e) {
                    return e.filter(function(e) {
                        if (void 0 !== e.slotPattern)
                            try {
                                e.slotPattern = new RegExp(e.slotPattern)
                            } catch (i) {
                                return I.error("error converting slot pattern ('" + e.slotPattern + "'); adunitPattern excluded"),
                                !1
                            }
                        if (void 0 !== e.divPattern)
                            try {
                                e.divPattern = new RegExp(e.divPattern)
                            } catch (i) {
                                return I.error("error converting div pattern ('" + e.divPattern + "'); adunitPattern excluded"),
                                !1
                            }
                        return !0
                    })
                ...
                var u = /##data\.(.+?)##/;
                function c(e, i, a) {
                    var s = "string" == typeof a ? e[a] : e;
                    if (a && "string" == typeof s) {
                        var d = u.exec(s);
                        d && (e[a] = i && i.hasOwnProperty(d[1]) ? i[d[1]] : "")
                    } else
                        "object" == typeof s && (Array.isArray(s) ? s.forEach(function(e, a) {
                            c(e, i, a)
                ...
                function x(e, i, a) {
                    var s = !0;
                    return a && (s = a.some(function(i) {
                        return e[0] === i[0] && e[1] === i[1]
                    })),
                    s && i && (s = i.some(function(i) {
                        return e[0] === i[0] && e[1] === i[1]
                    })),
                    s
                }
                function y(i, a, s) {
                    return s.find(function(s) {
                        var d = !1;
                        return z(s) && void 0 !== s.slotPattern && (d = s.slotPattern.test(i)),
                        !!d && (x(a, s.sizes, e.rp.sizes) ? (I.debug("adunitPattern/video match found:", s, i),
                        !0) : (I.warn("adunitPattern excluded because all video slot sizes filtered out:", s, i),
                        !1))
                    })
                }
                function z(e) {
                ...
                function v(e, i, a, s) {
                    if (a)
                        try {
                            ...
                            return d.sizes = [i],
                            d.code = e,
                            d.bids.forEach(function(e) {
                                c(e, f(s, e.bidder))
                            }),
                            delete d.slotPattern,
                            delete d.divPattern,
                            delete d.filteredSizes,
                            d
                        } catch (e) {
                            I.error("error parsing video adUnit", e)
                        }
                    else
                        I.warn("createVideoAdUnit: no adUnitPattern found for ad slot name:", e)
                }
                function f(e, i) {
                    if (e && "rubicon" === i) {
                        var a = JSON.parse(JSON.stringify(e));
                        return ["inventory", "visitor"].forEach(function(e) {
                            "object" == typeof a[e] && Object.keys(a[e]).forEach(function(i) {
                                var s = a[e][i];
                                "string" != typeof s && "number" != typeof s || (a[e][i] = [s])
                            })
                        }),
                        a
                    }
                ...
                return I.info("loading"),
                e.rp = e.rp || {},
                e.rp.adUnitPatterns = [],
                e.rp.addAdunitPatterns = function(i) {
                    I.debug("addAdUnitPatterns", i),
                    e.rp.adUnitPatterns = e.rp.adUnitPatterns.concat(b(i))
                }
                ,
                e.rp.requestBids = function(i) {
                    var a = i.gptSlotObjects || googletag.pubads().getSlots()
                      , s = p(a, e.rp.adUnitPatterns, i.data);
                    I.debug("requestBids:", i, s),
                    s.length ? e.requestBids({
                        bidsBackHandler: function() {
                            e.setTargetingForGPTAsync(),
                            i.callback && "function" == typeof i.callback ? (I.debug("bidsBackHandler execute callback"),
                            i.callback(a)) : (I.debug("callback undefined, refresh gpt slots"),
                            googletag.pubads().refresh(a))
                        },
                        adUnits: s
                    }) : (I.debug("requestBids cancelled, no adUnits available for auction"),
                    i.callback && "function" == typeof i.callback ? i.callback(a) : (I.debug("refresh gpt slots"),
                    googletag.pubads().refresh(a)))
                }
                ,
                e.rp.requestVideoBids = function(i) {
                    if ("string" == typeof i.adSlotName)
                        if ("function" == typeof i.callback)
                            if (Array.isArray(i.playerSize)) {
                                var a = v(i.adSlotName, i.playerSize, y(i.adSlotName, i.playerSize, e.rp.adUnitPatterns), i.data);
                                a && e.requestBids({
                                    adUnits: [a],
                                    bidsBackHandler: function(s) {
                                        var d = {
                                            adTagUrl: void 0,
                                            vastUrl: void 0
                                        }
                                          , r = i.adSlotName;
                                        if (s && s[r] && Array.isArray(s[r].bids) && s[r].bids.length) {
                                            d.adTagUrl = e.adServers.dfp.buildVideoUrl({
                                                adUnit: a,
                                                params: {
                                                    iu: i.adSlotName
                                                }
                                            });
                                            var t = e.getHighestCpmBids(i.adSlotName);
                                            d.vastUrl = void 0 !== t[0] ? t[0].vastUrl : void 0
                                        }
                                        i.callback(d, s)
                                    }
                                })
                            } else
                                I.error("requestVideoBids called without playerSize");
                        else
                            I.error("requestVideoBids called without a callback");
                    else
                        I.error("requestVideoBids called without adSlotName")
                }
                ,
                ...
                ,
                I.info("running"),
                this.__test__createLogUtils = i,
                this.__test__getFilteredGPTSlotSizes = a,
                this.__test__filterSlotSizes = r,
                this.__test__filterSlotSizesByIntersection = t,
                this.__test__hasValidSize = n,
                this.__test__findSlotPattern = o,
                this.__test__createAdUnits = p,
                this.__test__createAdUnit = m,
                this.__test__createVideoAdUnit = v,
                this.__test__wrapFirstPartyValuesInArrays = f,
                this.__test__convertPatternStringsToRegEx = b,
                this.__test__applyFirstPartyData = c,
                this.__test__playerSizeIsValid = x,
                this.__test__hasVideoMediaType = z,
                this.__test__findVideoPattern = y,
                this
            } catch (e) {
    ...
    2: [function(e, i, a) {
        ...
        pbjs.que = pbjs.que || [],
        pbjs.que.unshift((s = window.pbjs,
        function() {
            e("../lib/hpbv2.js")(s),
            s.rp.addAdunitPatterns([{
                mediaTypes: {
                    banner: {
                        sizes: [[728, 90], [300, 600], [300, 250], [970, 250], [970, 90]]
                    }
                },
                custParam: "kargoAdhesive",
                slotPattern: "/4442842/Business-Insider/Desktop/Finance*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685771
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Business-Insider/Desktop/Home*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685772
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Business-Insider/Desktop/Lifestyle*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685773
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Business-Insider/Desktop/Politics*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685774
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Business-Insider/Desktop/Sports*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685775
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Business-Insider/Desktop/Strategy*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685776
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Business-Insider/Desktop/Tech*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685777
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Business-Insider/Desktop*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685778
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Business-Insider/Mobile-Web/Finance*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685779
                    }
                }, {
                    bidder: "audienceNetwork",
                    params: {
                        format: "fullwidth",
                        placementId: "1325898517502065_2044042869020956"
                    }
                }, {
                    bidder: "audienceNetwork",
                    params: {
                        format: "fullwidth",
                        placementId: "1325898517502065_2044043475687562"
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Business-Insider/Mobile-Web/Home*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685780
                    }
                }, {
                    bidder: "audienceNetwork",
                    params: {
                ...
                slotPattern: "/4442842/Business-Insider/Mobile-Web/Lifestyle*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685781
                    }
                }, {
                    bidder: "audienceNetwork",
                    params: {
                        format: "fullwidth",
                        placementId: "1325898517502065_2044044052354171"
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Business-Insider/Mobile-Web/Politics*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685782
                    }
                }, {
                    bidder: "audienceNetwork",
                    params: {
                        format: "fullwidth",
                        placementId: "1325898517502065_2044044555687454"
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Business-Insider/Mobile-Web/Sports*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685783
                    }
                }, {
                    bidder: "audienceNetwork",
                    params: {
                        format: "fullwidth",
                        placementId: "1325898517502065_1338869282871655"
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Business-Insider/Mobile-Web/Strategy*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685784
                    }
                }, {
                    bidder: "audienceNetwork",
                    params: {
                        format: "fullwidth",
                        placementId: "1325898517502065_1338869506204966"
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Business-Insider/Mobile-Web/Tech*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685785
                    }
                }, {
                    bidder: "audienceNetwork",
                    params: {
                        format: "fullwidth",
                        placementId: "1325898517502065_2051884838236759"
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Business-Insider/Mobile-Web*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685786
                    }
                }, {
                    bidder: "audienceNetwork",
                    params: {
                        format: "fullwidth",
                        placementId: "1325898517502065_2051887098236533"
                    }
                }, {
                    bidder: "audienceNetwork",
                    params: {
                ...
                slotPattern: "/4442842/Insider/Desktop/Home*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685787
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Insider/Desktop/Food*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685788
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Insider/Desktop/Travel*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685789
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Insider/Desktop/Design*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685790
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Insider/Desktop/Culture*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685791
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Insider/Desktop/People*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685792
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Insider/Desktop/Health*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685793
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Insider/Desktop/Opinion*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685794
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Insider/Desktop*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685795
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Insider/Mobile-Web/Home*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685796
                    }
                }, {
                    bidder: "audienceNetwork",
                    params: {
                        format: "fullwidth",
                        placementId: "166105827360482_231719094132488"
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Insider/Mobile-Web/Food*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685797
                    }
                }, {
                    bidder: "audienceNetwork",
                    params: {
                        format: "fullwidth",
                        placementId: "166105827360482_231719930799071"
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Insider/Mobile-Web/Travel*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685798
                    }
                }, {
                    bidder: "audienceNetwork",
                    params: {
                        format: "fullwidth",
                        placementId: "166105827360482_231720820798982"
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Insider/Mobile-Web/Design*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685799
                    }
                }, {
                    bidder: "audienceNetwork",
                    params: {
                        format: "fullwidth",
                        placementId: "166105827360482_231721577465573"
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Insider/Mobile-Web/Culture*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685800
                    }
                }, {
                    bidder: "audienceNetwork",
                    params: {
                        format: "fullwidth",
                        placementId: "166105827360482_231722394132158"
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Insider/Mobile-Web/People*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685801
                    }
                }, {
                    bidder: "audienceNetwork",
                    params: {
                        format: "fullwidth",
                        placementId: "166105827360482_231723147465416"
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Insider/Mobile-Web/Health*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685802
                    }
                }, {
                    bidder: "audienceNetwork",
                    params: {
                        format: "fullwidth",
                        placementId: "166105827360482_231723830798681"
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Insider/Mobile-Web/Opinion*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685803
                    }
                }, {
                    bidder: "audienceNetwork",
                    params: {
                        format: "fullwidth",
                        placementId: "166105827360482_231724627465268"
                    }
                }, {
                    bidder: "openx",
                    params: {
                ...
                slotPattern: "/4442842/Insider/Mobile-Web*",
                bids: [{
                    bidder: "appnexus",
                    params: {
                        keywords: "##data.keywords##",
                        placementId: 13685804
                    }
                }, {
                    bidder: "audienceNetwork",
                    params: {
                        format: "fullwidth",
                        placementId: "166105827360482_231725287465202"
                    }
                }, {
                    bidder: "openx",
                    params: {
            ...
            s.setConfig({
                ...
                ix: {
                    firstPartyData: "##data.firstPartyData##"
                },
                bidderTimeout: 750,
                userSync: {
                    iframeEnabled: !0,
...
!(function(d) {
    ...
    0: function(e, o, t) {
        ...
        o.getLatestHighestCpmBid = o.getOldestHighestCpmBid = o.getHighestCpm = void 0;
        ...
        ,
        o.parseGPTSingleSizeArray = b,
        o.uniques = A,
        o.flatten = I,
        o.getBidRequest = function(n, e) {
            var r = void 0;
        ...
        ,
        o.isGptPubadsDefined = function() {
            if (window.googletag && o.isFn(window.googletag.pubads) && o.isFn(window.googletag.pubads().getSlots))
                return !0
        }
        ,
        ...
        ,
        o.adUnitsFilter = function(e, t) {
            return (0,
            d.default)(e, t && t.adUnitCode)
        }
        ,
        o.isSrcdocSupported = function(e) {
        ...
        ,
        o.replaceAuctionPrice = function(e, t) {
            if (!e)
                return;
        ...
        ,
        o.checkCookieSupport = function() {
            if (window.navigator.cookieEnabled || document.cookie.length)
                return !0
        }
        ,
        o.cookiesAreEnabled = function() {
            if (o.checkCookieSupport())
                return !0;
            return window.document.cookie = "prebid.cookieTest",
            -1 != window.document.cookie.indexOf("prebid.cookieTest")
        }
        ,
        o.delayExecution = function(e, t) {
            if (t < 1)
        ...
        ,
        o.createContentToExecuteExtScriptInFriendlyFrame = function(e) {
            if (!e)
                return "";
        ...
        ,
        o.getDefinedParams = function(n, e) {
            return e.filter((function(e) {
                return n[e]
            }
            )).reduce((function(e, t) {
        ...
        ,
        o.isValidMediaTypes = function(e) {
        ...
        ,
        o.getBidderRequest = function(e, t, n) {
            return (0,
        ...
        ,
        o.getUserConfiguredParams = function(e, t, n) {
            return e.filter((function(e) {
                return e.code === t
            }
            )).map((function(e) {
        ...
        ,
        o.isAdUnitCodeMatchingSlot = function(t) {
            return function(e) {
                return O(t, e)
            }
        }
        ,
        o.isSlotMatchingAdUnitCode = function(t) {
            return function(e) {
                return O(e, t)
            }
        }
        ,
        o.unsupportedBidderMessage = function(e, t) {
        ...
        ,
        o.deletePropertyFromObject = function(e, t) {
            var n = r({}, e);
            return delete n[t],
            n
        }
        ,
        o.removeRequestId = function(e) {
            return o.deletePropertyFromObject(e, "requestId")
        }
        ,
        ...
        ,
        o.convertCamelToUnderscore = function(e) {
        ...
        ,
        o.transformBidderParamKeywords = function(e) {
            var r = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : "keywords"
              , i = [];
            return o._each(e, (function(e, t) {
                if (o.isArray(e)) {
                    var n = [];
                    o._each(e, (function(e) {
                        (e = o.getValueString(r + "." + t, e)) && n.push(e)
                    }
                    )),
                    e = n
                } else {
                    if (e = o.getValueString(r + "." + t, e),
                    !o.isStr(e))
                        return;
                    e = [e]
                }
        ...
        o.replaceTokenInString = function(i, e, o) {
        ...
        function b(e) {
            if (o.isArray(e) && 2 === e.length && !isNaN(e[0]) && !isNaN(e[1]))
                return e[0] + "x" + e[1]
        }
        function h() {
            return window.console && window.console.log
        }
        o.getUniqueIdentifierStr = m,
        o.generateUUID = function e(t) {
            return t ? (t ^ 16 * Math.random() >> t / 4).toString(16) : ([1e7] + -1e3 + -4e3 + -8e3 + -1e11).replace(/[018]/g, e)
        }
        ,
        o.getBidIdParameter = function(e, t) {
            return t && t[e] ? t[e] : ""
        }
        ,
        o.tryAppendQueryString = function(e, t, n) {
            return n ? e + (t + "=") + encodeURIComponent(n) + "&" : e
        }
        ,
        o.parseQueryStringParameters = function(e) {
            var t = "";
            for (var n in e)
        ...
        ,
        o.transformAdServerTargetingObj = function(t) {
        ...
        ,
        o.getTopWindowLocation = function() {
            if (o.inIframe()) {
                var e = void 0;
                try {
                    e = o.getAncestorOrigins() || o.getTopFrameReferrer()
                } catch (e) {
            ...
            return o.getWindowLocation()
        }
        ,
        o.getTopFrameReferrer = function() {
            try {
        ...
        ,
        o.getWindowTop = function() {
            return window.top
        }
        ,
        o.getWindowSelf = function() {
            return window.self
        }
        ,
        o.getWindowLocation = function() {
            return window.location
        }
        ,
        o.getTopWindowUrl = function() {
            var t = void 0;
            try {
        ...
        ,
        o.getTopWindowReferrer = function() {
            try {
        ...
        ,
        o.logWarn = function(e) {
            E() && console.warn && console.warn("WARNING: " + e)
        }
        ,
        o.logInfo = function(e, t) {
            E() && h() && p && (t && 0 !== t.length || (t = ""),
            p("INFO: " + e + ("" === t ? "" : " : params : "), t))
        }
        ,
        o.logMessage = function(e) {
            E() && h() && console.log("MESSAGE: " + e)
        }
        ,
        o.hasConsoleLogger = h;
        var E = function() {
            if (!1 === n.config.getConfig("debug") && !1 === l) {
                var e = "TRUE" === S(f.DEBUG_MODE).toUpperCase();
                n.config.setConfig({
                    debug: e
                }),
                l = !0
        ...
        ,
        o.createInvisibleIframe = function() {
        ...
        o.getParameterByName = S,
        o.hasValidBidRequest = function(e, n, t) {
            var r = !1;
            function i(e, t) {
                t === n[o] && (r = !0)
            }
        ...
        ,
        o.isEmptyStr = function(e) {
            return this.isStr(e) && (!e || 0 === e.length)
        }
        ,
        o._each = function(e, t) {
            if (!this.isEmpty(e)) {
        ...
        o.insertElement = function(e, t, n) {
            t = t || document;
            var r = void 0;
        ...
        ,
        o.triggerPixel = function(e) {
            (new Image).src = e
        }
        ,
        o.callBurl = function(e) {
            var t = e.source
              , n = e.burl;
            t === f.S2S.SRC && n && o.triggerPixel(n)
        }
        ,
        o.insertHtmlIntoIframe = function(e) {
            if (e) {
                var t = document.createElement("iframe");
                t.id = o.getUniqueIdentifierStr(),
                t.width = 0,
                t.height = 0,
                t.hspace = "0",
                t.vspace = "0",
        ...
        ,
        o.insertUserSyncIframe = function(e) {
        ...
        ,
        o.createTrackPixelHtml = function(e) {
            if (!e)
                return "";
        ...
        ,
        o.createTrackPixelIframeHtml = function(e) {
        ...
        ,
        o.getIframeDocument = function(e) {
            if (e) {
                var t = void 0;
                try {
        ...
        ,
        o.getValueString = function(e, t, n) {
        ...
        ;
        o.getHighestCpm = C("timeToRespond", (function(e, t) {
            return t < e
        }
        )),
        o.getOldestHighestCpmBid = C("responseTimestamp", (function(e, t) {
            return t < e
        }
        )),
        o.getLatestHighestCpmBid = C("responseTimestamp", (function(e, t) {
            return e < t
        }
        ));
        function C(n, r) {
    ...
    16: function(e, t, n) {
        var v = n(20)
          ...
          , E = "prototype"
          , S = function(e, t, n) {
            var r, i, o, a = e & S.F, u = e & S.G, d = e & S.S, s = e & S.P, c = e & S.B, f = e & S.W, l = u ? y : y[t] || (y[t] = {}), g = l[E], p = u ? v : d ? v[t] : (v[t] || {})[E];
            for (r in u && (n = t),
            n)
    ...
    187: function(e, t, n) {
        ...
        t.newAuction = function(e) {
            ...
            function s(e, t) {
                ...
                null != m) {
                    var n = [];
                    e && (_.logMessage("Auction " + v + " timedOut"),
                    u = p,
                    ...
                    ))).length && C.emit(O.EVENTS.BID_TIMEOUT, n)),
                    ...
                    try {
                        y = R;
                        var r = l
                          , i = [p.filter(E.adUnitsFilter.bind(this, r)).reduce(D, {})];
                        m.apply(pbjs, i)
                    } catch (e) {
                        _.logError("Error executing bidsBackHandler", null, e)
                    } finally {
                        n.length && w.callTimedOutBidders(f, n, h);
            ...
            function c() {
                ...
                )) && (_.logInfo("Bids Received for Auction with id: " + v, p),
                y = R,
                s(!1, !0))
            }
            return {
                ...
                callBids: function() {
                    ...
                    var r = w.makeBidRequests(o, u, v, h, a);
                    _.logInfo("Bids Requested for Auction with id: " + v, r),
                    ...
                    y = N,
                    w.callBids(o, r, U.bind(this), function(e) {
                        var t = e;
                        return (0,
                        E.delayExecution)((function() {
                            var e = (0,
        ...
        var I = r.userSync.syncUsers
          ...
          , N = t.AUCTION_IN_PROGRESS = "inProgress"
          , R = t.AUCTION_COMPLETED = "completed";
        function f(e, t) {
            t.timeToRespond > e.getTimeout() + S.config.getConfig("timeoutBuffer") && e.executeCallback(!0)
        }
        function y(e, t) {
            C.emit(O.EVENTS.BID_RESPONSE, t),
            e.addBidReceived(t),
            f(e, t)
        }
        ...
        o.createHook)("asyncSeries", (function(e, t) {
            ...
            E.getBidderRequest)(a, t.bidderCode, e), s = (function(e) {
                ...
                C.emit(O.EVENTS.BID_ADJUSTMENT, a);
                var u = r.bids && (0,
                T.default)(r.bids, (function(e) {
            ...
            i = d,
            o = !0,
            S.config.getConfig("cache.url") && (r.videoCacheKey ? r.vastUrl || (_.logError("videoCacheKey specified but not required vastUrl for video bid"),
            o = !1) : (o = !1,
            (0,
            c.store)([r], (function(e, t) {
                e ? (_.logWarn("Failed to save to the video cache: " + e + ". Video bid must be discarded."),
        ...
        function u(e) {
            ...
            return r[O.JSON_MAPPING.BD_SETTING_STANDARD] || (r[O.JSON_MAPPING.BD_SETTING_STANDARD] = {}),
            r[O.JSON_MAPPING.BD_SETTING_STANDARD][O.JSON_MAPPING.ADSERVER_TARGETING] || (r[O.JSON_MAPPING.BD_SETTING_STANDARD][O.JSON_MAPPING.ADSERVER_TARGETING] = [{
                key: "hb_bidder",
                val: function(e) {
                    return e.bidderCode
                }
        ...
        function m(e, t) {
            ...
            e && r[e] && r[e][O.JSON_MAPPING.ADSERVER_TARGETING] && (d(n, r[e], t),
        ...
        function d(r, i, o) {
            ...
            _._each(e, (function(e) {
                var t = e.key
                  , n = e.val;
                if (r[t] && _.logWarn("The key: " + t + " is getting ovewritten"),
                _.isFn(n))
                    try {
                        n = n(o)
                    } catch (e) {
        ...
        function s(e) {
            var t = e.bidderCode
              , n = e.cpm
              , r = void 0;
            if (pbjs.bidderSettings && (t && pbjs.bidderSettings[t] && "function" == typeof pbjs.bidderSettings[t].bidCpmAdjustment ? r = pbjs.bidderSettings[t].bidCpmAdjustment : pbjs.bidderSettings[O.JSON_MAPPING.BD_SETTING_STANDARD] && "function" == typeof pbjs.bidderSettings[O.JSON_MAPPING.BD_SETTING_STANDARD].bidCpmAdjustment && (r = pbjs.bidderSettings[O.JSON_MAPPING.BD_SETTING_STANDARD].bidCpmAdjustment),
            r))
                try {
                    n = r(e.cpm, g({}, e))
                } catch (e) {
    ...
    22: function(e, t, n) {
        n(101),
        e.exports = n(15).Array.findIndex
    },
    23: function(e, t, n) {
    ...
    29: function(e, t, n) {
        ...
        var r, i = n(0), s = n(187), o = n(10), a = (r = o) && r.__esModule ? r : {
            default: r
        };
        var u = n(4);
        function d() {
    ...
    33: function(e, t, n) {
        ...
        e.exports = function(f, e) {
            var l = 1 == f
              ...
              , b = e || r;
            return function(e, t, n) {
                for (var r, i, o = S(e), a = E(o), u = h(t, n, 3), d = T(a.length), s = 0, c = l ? b(e, d) : g ? b(e, 0) : void 0; s < d; s++)
    ...
    39: function(e, t, n) {
        ...
        t.newTargeting = c;
        var r, E = n(0), S = n(2), T = n(18), i = n(29), o = n(7), A = (r = o) && r.__esModule ? r : {
            default: r
        };
        function I(e, t, n) {
        ...
        function c(n) {
            ...
            g.getAllTargeting = function(e) {
                ...
                )))).concat(S.config.getConfig("enableSendAllBids") ? (r = f,
                t = c,
                i = w.TARGETING_KEYS.concat(T.NATIVE_TARGETING_KEYS),
    ...
    4: function(e, t) {
        e.exports = {
            ...
            REPO_AND_VERSION: "prebid_prebid_1.14.0",
    ...
    490: function(e, t, n) {
        ...
        , a = n(38), u = n(0), d = n(491), s = n(14), c = n(11), f = n(2), l = n(29), g = n(39), p = n(21), v = n(7), y = (r = v) && r.__esModule ? r : {
            default: r
        };
        var m = (0,
        a.getGlobal)()
          ...
          , k = {
            bidWon: function(e) {
                ...
                if (!h.contains(t, e))
                    return void h.logError('The "' + e + '" placement is not defined.');
                return !0
            }
        };
        function M(e, t, n) {
        ...
        m.libLoaded = !0,
        m.version = "v1.14.0",
        h.logInfo("Prebid.js v1.14.0 loaded"),
        m.adUnits = m.adUnits || [],
        ...
        m.setTargetingForAst = function() {
            ...
            T.emit(O, g.targeting.getAllTargeting())) : h.logError("window.apntag is not defined on the page")
        }
        ,
        m.renderAd = function(e, t) {
            ...
            e && t)
                try {
                    ...
                    if (n) {
                        ...
                        d && d.url)
                            ...
                            x(R, "Error trying to write ad. Ad render call ad id " + t + " was prevented from writing to the main document.", n)
                        } else if (o)
                            e.write(o),
                            e.close(),
                            M(e, i, r),
                            ...
                            x(U, "Error trying to write ad. No ad for bid response id: " + t, n)
                        }
                    } else {
                        x(j, "Error trying to write ad. Cannot find ad by given id : " + t)
                    }
                } catch (e) {
                ...
                x(P, "Error trying to write ad Id :" + t + " to the page. Missing document or adId")
        }
        ,
        ...
        m.onEvent = function(e, t, n) {
            ...
            h.isFn(t) ? !n || k[e].call(null, n) ? T.on(e, t, n) : h.logError('The id provided is not valid for event "' + e + '" and no handler was set.') : h.logError('The event handler provided is not a function and was not set on event "' + e + '".')
        }
        ,
        m.offEvent = function(e, t, n) {
            h.logInfo("Invoking pbjs.offEvent", arguments),
            n && !k[e].call(null, n) || T.off(e, t, n)
        }
        ,
    ...
    491: function(e, t, n) {
        ...
        function o(e) {
            ...
            if (v.adId) {
                var y = (0,
                S.default)(E.auctionManager.getBidsReceived(), (function(e) {
        ...
        function r() {
            ...
            return function(e, t, n) {
                ...
                try {
                    ...
                    g._each(r.customHeaders, (function(e, t) {
    ...
    8: function(e, b, t) {
            ...
            if (O.enabled) {
                ...
                (s = A.deepClone(n)).forEach((function(e) {
                    e.bids = e.bids.filter((function(e) {
                        return (0,
                        S.default)(d, e.bidder) && (!N() || e.finalSource !== w.CLIENT)
                    }
                    )).map((function(e) {
        ...
        b.registerBidAdapter = function(e, t) {
            ...
            (0,
            S.default)(r, "video") && b.videoAdapters.push(t),
            (0,
            S.default)(r, "native") && g.nativeAdapters.push(t)) : A.logError("Bidder adaptor error for bidder code: " + t + "bidder must implement a callBids() function") : A.logError("bidAdaptor or bidderCode not specified")
        }
        ,
            ...
            if (void 0 === C[e]) {
                ...
                if (void 0 === i)
                    ...
                    try {
                        ...
                        r = [],
                        (0,
                        S.default)(b.videoAdapters, n) && r.push("video"),
                        (0,
                        S.default)(g.nativeAdapters, n) && r.push("native"),
                        r);
...
pbjsChunk([115], {
    ...
    125: function(e, r, a) {
        ...
        function b(r) {
            ...
            r.params.privateSizes && (a.private_sizes = g(r.params.privateSizes)),
...
pbjsChunk([112], {
    ...
    134: function(a, e, t) {
        ...
        var w = function(a) {
          ...
          , h = function(a) {
            return (0,
            o.default)(["300x250", "320x50"], a)
        }
          , v = function(a) {
            return (0,
            o.default)(["video", "native"], a)
        }
          , _ = function(a) {
            return "video" === a
        }
          ...
          , c = e.spec = {
            ...
            isBidRequestValid: function(a) {
                return "object" === n(a.params) && "string" == typeof a.params.placementId && 0 < a.params.placementId.length && Array.isArray(a.sizes) && 0 < a.sizes.length && (!y(a.params.format) || a.sizes.map(w).some((function(a) {
                    return "300x250" === a
                }
                ))) && (v(a.params.format) || a.sizes.map(w).some(h))
            },
            buildRequests: function(a) {
                ...
                a.forEach((function(n) {
                    return n.sizes.map(w).filter((function(a) {
                        return e = a,
                        t = n.params.format,
                        y(t) && "300x250" === w(e) || v(t) || h(w(e));
                        var e, t
                    }
                    )).slice(0, 1).forEach((function(a) {
                        var e;
                        t.push(n.params.placementId),
                        r.push(n.params.format || a),
                        i.push(a),
                        o.push((e = n.params.format,
                        _(e) ? "" : "5.5.web")),
                        d.push(n.bidId)
                    }
                    ))
            ...
            interpretResponse: function(a, e) {
                ...
                return Object.keys(r).map((function(a) {
                    ...
                    if (_(d)) {
                        var l = x();
                        p.mediaType = "video",
                        p.vastUrl = "https://an.facebook.com/v1/instream/vast.xml?placementid=" + i + "&pageurl=" + l + "&playerwidth=" + u + "&playerheight=" + f + "&bidid=" + r
                    }
                    return p
                }
                ))
...
pbjsChunk([0], {
    ...
    254: function(r, e, t) {
        ...
        e.spec = void 0;
        var m = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(r) {
            return typeof r
        }
        : function(r) {
        ...
        var v = e.spec = {
            ...
            isBidRequestValid: function(r) {
                ...
                if (!(function(r, e) {
                    ...
                    return !1;
                if ("string" != typeof r.params.siteId)
                    return !1;
                var e, t, n = r.params.hasOwnProperty("bidFloor"), o = r.params.hasOwnProperty("bidFloorCur");
                return !n && !o || n && o && (e = r.params.bidFloor,
                t = r.params.bidFloorCur,
                Boolean("number" == typeof e && "string" == typeof t && t.match(/^[A-Z]{3}$/)))
            },
            buildRequests: function(r, e) {
                for (var t, n, o = [], i = null, a = null, s = 0; s < r.length; s++)
                    i = r[s],
            ...
            interpretResponse: function(r) {
                ...
                if (!r.hasOwnProperty("body") || !r.body.hasOwnProperty("seatbid"))
                    return e;
                for (var n, o, i, a = r.body, s = a.seatbid, p = 0; p < s.length; p++)
    ...
    257: function(r, e, t) {
        t(258),
        r.exports = t(15).Number.isInteger
    },
    258: function(r, e, t) {
        var n = t(16);
        n(n.S, "Number", {
    ...
    268: function(e, r, t) {
        ...
        var i = r.spec = {
            ...
            buildRequests: function(e, r) {
                var t = u.config.getConfig("currency")
                  , n = o({}, {
                    ...
                    adSlotIds: c._map(e, (function(e) {
                        return e.params.placementId
                    }
                    ))
                }, i._getAllMetadata())
                  , a = encodeURIComponent(JSON.stringify(n));
                return o({}, r, {
                    method: "GET",
                    url: "https://krk.kargo.com/api/v1/bid",
                    data: "json=" + a,
                    currency: t
                })
            },
            interpretResponse: function(e, r) {
                var t = e.body
                  , n = {};
                c._each(r.bids, (function(e) {
                    return n[e.params.placementId] = e
                }
                ));
                var a = [];
                for (var o in t) {
            ...
            _getCrbIds: function() {
                try {
                    var e = JSON.parse(decodeURIComponent(i._readCookie("krg_crb")))
                      , r = {};
                    if (e && e.v) {
                        var t = JSON.parse(atob(e.v));
                        t && t.syncIds && (r = t.syncIds)
                    }
                    return r
                } catch (e) {
                    return {}
            ...
            _getUid: function() {
                try {
                    var e = JSON.parse(decodeURIComponent(i._readCookie("krg_uid")))
                      , r = {};
                    return e && e.v && (r = e.v),
                    r
                } catch (e) {
            ...
            _getKruxUserId: function() {
                return i._getLocalStorageSafely("kxkar_user")
            },
            _getKruxSegments: function() {
                return i._getLocalStorageSafely("kxkar_segs")
            },
            _getKrux: function() {
                var e = i._getKruxSegments()
                  , r = [];
                return e && (r = e.split(",")),
                {
                    userID: i._getKruxUserId(),
                    segments: r
                }
            },
            ...
            _getAllMetadata: function() {
                return {
                    userIDs: i._getUserIds(),
                    krux: i._getKrux(),
                    pageURL: window.location.href,
                    rawCRB: i._readCookie("krg_crb")
                }
            }
        };
        (0,
...
pbjsChunk([38], {
    ...
    385: function(e, t, n) {
        ...
        var s = o.default.EVENTS
          ...
          , U = u.NO_BID
          , A = void 0;
        f.config.getConfig("s2sConfig", (function(e) {
            var t = e.s2sConfig;
            A = t
        }
        ));
        var _ = t.SEND_TIMEOUT = 3e3
          , O = "pbjs"
          , S = {
            auctions: {},
            targeting: {},
        ...
        function D(a, s) {
            return s.reduce((function(e, t, n) {
                ...
                i = r[2]);
                var o = a[t];
                return "function" == typeof s[n + 1] && (o = s[n + 1](o, e)),
                void 0 !== o && (e[i] = o),
                e
            }
            ), {})
        ...
        function C(e, t) {
            function o(e) {
                return D(e, ["bidder", "bidId", "status", "error", "source", function(e, t) {
                    return e || (A && Array.isArray(A.bidders) && -1 !== A.bidders.indexOf(t.bidder) ? "server" : "client")
                }
                , "clientLatencyMillis", "serverLatencyMillis", "params", "bidResponse", function(e) {
                    return e ? D(e, ["bidPriceUSD", "dealId", "dimensions", "mediaType"]) : void 0
                }
                ])
            }
            function i(e) {
                return d(o(e), D(e.adUnit, ["adUnitCode", "transactionId", "videoAdFormat", function() {
                    return e.videoAdFormat
                }
                , "mediaTypes"]), {
                    adserverTargeting: N(S.targeting[e.adUnit.adUnitCode] || {}),
                    bidwonStatus: "success",
                    accountId: w,
                    samplingFactor: k
                })
            }
            var n = f.config.getConfig("pageUrl") || p.getTopWindowUrl()
              , r = {
            ...
            if (a && !a.sent) {
                var s = Object.keys(a.bids).reduce((function(e, t) {
                    ...
                    i || ((i = e[n.adUnit.adUnitCode] = D(n.adUnit, ["adUnitCode", "transactionId", "mediaTypes", "dimensions", "adserverTargeting", function() {
                        return N(S.targeting[n.adUnit.adUnitCode] || {})
                    }
                    ])).bids = []),
                    n.videoAdFormat && !i.videoAdFormat && (i.videoAdFormat = n.videoAdFormat);
                    var r = ["error", "no-bid", "success"];
                    return r.indexOf(n.status) > r.indexOf(i.status) && (i.status = n.status),
                    i.bids.push(o(n)),
                    e
                }
                ), {})
                ...
                A && (u.serverTimeoutMillis = A.timeout),
                r.auctions = [u];
                var c = Object.keys(a.bidsWon).reduce((function(e, t) {
                    var n = a.bidsWon[t];
                    return n && e.push(i(a.bids[n])),
                    e
                }
                ), []);
                0 < c.length && (r.bidsWon = c),
                a.sent = !0
            } else
                t && a && a.bids[t] && (r.bidsWon = [i(a.bids[t])]);
            (0,
            l.ajax)(this.getUrl(), null, JSON.stringify(r), {
          ...
          , q = d({}, F, {
            enableAnalytics: function() {
                var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}
                  , t = !1;
                k = 1,
                "object" === c(e.options) && (e.options.accountId && (w = Number(e.options.accountId)),
                e.options.endpoint ? this.getUrl = function() {
                    return e.options.endpoint
                }
                : (p.logError("required endpoint missing from rubicon analytics"),
                t = !0),
                void 0 !== e.options.sampling && (k = 1 / parseFloat(e.options.sampling)),
                void 0 !== e.options.samplingFactor && (void 0 !== e.options.sampling && p.logWarn("Both options.samplingFactor and options.sampling enabled in rubicon analytics, defaulting to samplingFactor"),
                k = parseFloat(e.options.samplingFactor),
                e.options.sampling = 1 / k));
                var n = [1, 10, 20, 40, 100];
                -1 === n.indexOf(k) ? (t = !0,
                p.logError("invalid samplingFactor for rubicon analytics: " + k + ", must be one of " + n.join(", "))) : w || (t = !0,
                p.logError("required accountId missing for rubicon analytics")),
                t || F.enableAnalytics.call(this, e)
            },
            disableAnalytics: function() {
                this.getUrl = F.getUrl,
                w = null,
                F.disableAnalytics.apply(this, arguments)
            },
            track: function(e) {
                var t, n, i = this, r = e.eventType, o = e.args;
                switch (r) {
                case b:
                    var a = D(o, ["timestamp", "timeout"]);
                    a.bids = {},
                    a.bidsWon = {},
                    S.auctions[o.auctionId] = a;
                    break;
                case v:
                    d(S.auctions[o.auctionId].bids, o.bids.reduce((function(e, i) {
                        return S.auctions[o.auctionId].bidsWon[i.adUnitCode] = !1,
                        e[i.bidId] = D(i, ["bidder", function(e) {
                        ...
                        , "finalSource as source", "params", function(e, t) {
                            switch (t.bidder) {
                            case "rubicon":
                                return D(e, ["accountId", "siteId", "zoneId"])
                            }
                        }
                        , "videoAdFormat", function(e, t) {
                            ...
                            var n = parseInt(p.deepAccess(i, "params.video.startdelay"), 10);
                        ...
                        , "adUnit", function() {
                            return D(i, ["adUnitCode", "transactionId", "sizes as dimensions", function(e) {
                                return e.map(M)
                            }
                            , "mediaTypes", function(e) {
                                return i.mediaType && j(i.mediaType) ? [i.mediaType] : Array.isArray(e) ? e.filter(j) : "object" === (void 0 === e ? "undefined" : c(e)) ? (i.sizes || (i.dimensions = [],
                                p._each(e, (function(e) {
                                    return i.dimensions = i.dimensions.concat(e.sizes.map(M))
                                }
                                ))),
                                Object.keys(e).filter(j)) : ["banner"]
                            }
                            ])
                        }
                        ]),
                    ...
                    break;
                case g:
                    var s = S.auctions[o.auctionId].bids[o.adId];
                    switch (s.source = (void 0 === (n = s.source || o.source) ? n = "client" : "s2s" === n && (n = "server"),
                    n.toLowerCase()),
                    o.getStatusCode()) {
                    case E:
                        s.status = "success",
                    ...
                    s.clientLatencyMillis = Date.now() - S.auctions[o.auctionId].timestamp,
                    s.bidResponse = D(t = o, ["getCpmInNewCurrency as bidPriceUSD", function(e) {
                        return "USD" === t.currency ? Number(t.cpm) : "function" == typeof e ? Number(e("USD")) : void 0
                    }
                    , "dealId", "status", "mediaType", "dimensions", function() {
                        return D(t, ["width", "height"])
                    }
                    ]);
                    break;
                case m:
                    o.bids.forEach((function(e) {
                        var t = S.auctions[e.auctionId].bids[e.bidId || e.adId];
                        void 0 !== e.serverResponseTimeMs && (t.serverLatencyMillis = e.serverResponseTimeMs),
                        t.status || (t.status = "no-bid"),
                        t.clientLatencyMillis || (t.clientLatencyMillis = Date.now() - S.auctions[e.auctionId].timestamp)
                    }
                    ));
                    break;
                case h:
                    ...
                    break;
                case I:
                    var u = S.auctions[o.auctionId];
                    u.bidsWon[o.adUnitCode] = o.adId,
                    !0 === u.sent ? C.call(this, o.auctionId, o.adId) : Object.keys(u.bidsWon).reduce((function(e, t) {
                        return e = e && u.bidsWon[t]
                    }
                    ), !0) && (clearTimeout(S.timeouts[o.auctionId]),
                    delete S.timeouts[o.auctionId],
                    C.call(this, o.auctionId));
                    break;
                case y:
                    S.timeouts[o.auctionId] = setTimeout((function() {
                        C.call(i, o.auctionId)
                    }
                    ), _);
                    break;
                case T:
    ...
    5: function(e, t, n) {
        ...
        ;
        t.default = function(e) {
            var r, o = e.url, t = e.analyticsType, a = e.global, i = e.handler, s = [], u = 0, n = !0;
            t === D && (0,
            p.loadScript)(o, l);
            (t === N || M) && l();
            return {
                track: function(e) {
                    var t = e.eventType
                      , n = e.args;
                    (this.getAdapterType() === D || M) && window[a](i, t, n);
                    this.getAdapterType() === N && function(e) {
                        var t = e.eventType
                          , n = e.args
                          , i = e.callback;
                        (0,
                        b.ajax)(o, i, JSON.stringify({
                            eventType: t,
                            args: n
                        }))
                    }
            ...
            function d(t) {
                ...
                y(e, m, (function(e) {
                    e.config = "object" === (void 0 === t ? "undefined" : f(t)) && t.options || {},
                    n.enqueue({
                        eventType: m,
                        args: e
                    })
                ...
                ))) : g.logMessage('Analytics adapter for "' + a + '" disabled by sampling');
                this._oldEnable = this.enableAnalytics,
                this.enableAnalytics = function() {
                    return g.logMessage('Analytics adapter for "' + a + '" already enabled, unnecessary call to `enableAnalytics`.')
                }
            }
            function l() {
                if (n) {
                ...
                g.logMessage("event count sent to " + a + ": " + u)
            }
        }
        ;
        var i, r = n(4), o = (i = r) && i.__esModule ? i : {
            default: i
        }, p = n(11), b = n(6);
        function y(e, t, n) {
            return t in e ? Object.defineProperty(e, t, {
