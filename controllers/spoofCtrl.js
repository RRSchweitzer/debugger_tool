...
module.exports = {
	...
	appnexus: (req, res) =>  {
		...
		if(tagid === 22366045) { // Stick Outstream
			...
			res.send({
				...
				"tags": [{
					...
					"ads": [{
						"content_source": "rtb",
						"ad_type": "video",
						"notify_url": "https://nym1-ib.adnxs.com/vast_track/v2?info=ZwAAAAMArgAFAQlptSNhAAAAABFW0h4_l06xLxlptSNhAAAAACCgno5pKAAwvAk49A5A0vUtSPDUclCXzfoGWLLiFmICVVNoAXABeACAAQKIAQGQAYAFmAHoAqABAKgBoJ6OabABAQ..&s=331d21a84b923f9fb5cf73fa2aef848ce8a0357f&event_type=1",
		...
		} else if(tagid === 15504193 || tagid === 15504209){ //delete the zeros to make this work
			res.send({
				"version": "3.0.0",
				"tags": [
					{
	...
	teads: (req, res ) => {
		...
		res.send({
			"responses": [{
				...
				"width": "1",
				"height": "1",
				"ad": "<script type=\"text/javascript\" class=\"teads\" async=\"true\" src=\"https://localhost:7070/loadpic" + "\"></script>"
			}]
		})
	},
	pubmatic: (req, res) => {
	...
	domainConfig:(req, res)=> {
		...
		res.send({
			...
			"config": {
				...
				"adtagurl": "https://pubads.g.doubleclick.net/gampad/ads?iu=/22558409563,102691747/dorkaholics_preroll&description_url=https%3A%2F%2Fwww.dorkaholics.com%2F&tfcd=0&npa=0&sz=400x300%7C640x480&gdfp_req=1&output=vast&env=vp&unviewed_position_start=1&impl=s&correlator=",
		...
		res.send(
			apstag.bids({
				"slots": [{
					...
					"mediaType_sp": "d",
					"targeting": ["amzniid_sp", "amznp_sp", "amzndeal_sp", "amznsz_sp", "amznbid_sp", "amzniid", "amznp", "amznsz", "amznbid"],
					"size": "300x250",
